        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto justify-content-start">
            {currentUser ? ([
              ...
              <Nav.Link id="stuff-categories" as={NavLink} to="/categories" key="categories">Category</Nav.Link>,
              <Nav.Link id="add-complaints" as={NavLink} to="/complaints" key="complaints">File a Complaint</Nav.Link>,
            ]) : ''}
            {Roles.userIsInRole(Meteor.userId(), 'admin') ? (
              <Nav.Link id="list-stuff-admin-nav" as={NavLink} to="/admin" key="admin">List Profiles</Nav.Link>
            ) : ''}
          </Nav>
